...
public class encoder{
   ...
   //Returns a String array containing symbol, freq, and the bits, for every character
   public String[] encodings(){
      ...
      for(int i=0; i<chars.length();i++){
         ...
         String freq = splits[0];
         toReturn.add(c+"");
         toReturn.add(freq);
         toReturn.add(splits[1]);
      }
   ...
   //Returns a String consisting of freq+bits for a given character using the tree
