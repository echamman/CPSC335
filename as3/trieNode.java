/*
   ...
   Each node has siblings and children, the siblings represent letters that can substitute each other, and children
   represent letters that come after the parent
   The node only links to a left and right sibling, and one child
